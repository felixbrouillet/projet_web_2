    ...
    public function authentifier(Request $request) {
        ...
        if (Auth::attempt($valides)) {
            ...
            if ($role === 'client') {
                ...
                return redirect()->intended(route('index'))->with('succes', 'Connexion réussie.');
            } else {
                // Redirection vers le dashboard pour les administrateurs
                return redirect()->intended(route('dashboard.index'))->with('succes', 'Connexion réussie.');
            }
        }
        ...
        return back()
                ...
                ->onlyInput('email')
                ->with('erreur', 'Problème lors de la connexion');
    }
}
